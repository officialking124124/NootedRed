...
class NRed
{
    ...
    {    // TODO: Remove!
        ...
        static constexpr UInt8 IsRembrandt    = getBit(5);
    ...
    public:
        ...
        constexpr bool isRembrandt() const { return (this->value & IsRembrandt) != 0; }
        ...
        constexpr void setRembrandt() { this->value |= IsRembrandt; }
    };
